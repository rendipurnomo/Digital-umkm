        ...
        <Row>
          ...
          <Col lg="3" md="4" sm="6">
            <div className="mb-4">
              ...
              <p className="office__info">Surakarta, Indonesia</p>
              <p className="office__info">Phone: 08995232430</p>

              <p className="office__info">Email: Office@UMKM.com</p>
